...
module.exports = {
	...
	// Style options.
	styleSRC: './src/sass/albus-style.scss', // Path to main .scss file.
	...
	// Translation options.
	textDomain: 'albus-admin', // Your textdomain here.
	translationFile: 'albus-admin.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'Albus Admin', // Package name.
	bugReport: 'https://github.com/Kreislinie/Albus/issues', // Where can users report bugs.
	lastTranslator: '', // Last translator Email ID.
	team: 'Kreislinie <info@kreislinie.com>', // Team's Email ID.
